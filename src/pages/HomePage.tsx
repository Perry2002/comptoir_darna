  ...
  return (
    <div ref={revealRef} className="bg-surface">
        ...
        <div className="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop">
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center mb-24 md:mb-32">
            ...
            <div className="relative flex items-center justify-center reveal">
              <div className="relative md:-translate-x-16 lg:-translate-x-24">
                ...
                <div className="relative z-10 w-64 h-64 md:w-96 md:h-96 rounded-full overflow-hidden shadow-2xl border-8 border-primary">
                  <img
                    src="https://res.cloudinary.com/djvqjz65z/image/upload/f_auto,q_auto/v1784304282/GRA_ogpe10.webp"
                ...
                <div className="hidden md:flex absolute -right-24 lg:-right-32 top-1/2 -translate-y-1/2 flex-col gap-4 z-20">
                  {categoryChips.map((c) => (
                    <div
                      key={c.label}
                      className="flex items-center gap-3 bg-white/90 backdrop-blur-sm p-2 pr-6 rounded-full shadow-lg border border-primary/20 hover:translate-x-2 transition-transform cursor-default group"
                    >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-gutter mb-20 ">
            {popularDishes.map((dish, i) => (
              <motion.div
                ...
                variants={fadeUp}
                className="bg-[#FFFFFF] p-6 rounded-xl border border-primary shadow-sm hover:shadow-md transition-shadow text-center group flex flex-col h-full transition-all duration-300 ease-out hover:-translate-x-2 hover:scale-[1.02] hover:shadow-xl hover:border-primary/5"
              >
                <div className="w-28 h-28 md:w-40 md:h-40 mx-auto mb-4 rounded-full overflow-hidden border-4 border-primary">
                  <img
                    src={dish.image}
                    alt={dish.name}
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center mt-24 reveal">
            <div className="relative">
              <div className="w-full aspect-square max-w-md mx-auto rounded-xl overflow-hidden">
                <img
                  src="https://res.cloudinary.com/djvqjz65z/image/upload/v1784311017/Design-sans-titre-_3__zxbgs2.webp"
                  alt="Notre chef en cuisine"
                  className="w-full h-full object-cover"
                  loading="lazy"
                />
              </div>
              <div className="absolute bottom-0 -right-4 bg-primary text-on-primary p-6 rounded-xl shadow-lg hidden md:block">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-gutter mt-12">
            {chefs.map((chef) => (
              <div key={chef.id} className="group">
                <div className="relative w-48 h-48 md:w-64 md:h-64 mx-auto mb-6 rounded-full overflow-hidden border-4 border-primary shadow-lg transition-transform duration-500 group-hover:scale-105">
                  <img
                    src={chef.image}
                    alt={chef.name}
                    className="w-full h-full object-cover"
      ...
      <section className="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop mb-stack-lg">
        <div className="bg-surface-container-low p-8 md:p-20 rounded-xl border border-primary relative overflow-hidden grid md:grid-cols-2 gap-12 items-center shadow-sm reveal">
          ...
          <div className="relative flex justify-center items-center">
            <div className="relative z-10 w-full aspect-[16/9] rounded-xl overflow-hidden shadow-xl border border-primary">
              <img
                src="https://res.cloudinary.com/djvqjz65z/image/upload/f_auto,q_auto/v1784303457/15_op3ihg.webp"
        ...
        <div className="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-12 items-start reveal">
            <div className="md:col-span-7 relative mb-10 md:mb-0">
              ...
              <div className="md:absolute md:-bottom-8 md:-right-4 mt-4 md:mt-0 bg-surface p-6 md:p-8 shadow-2xl max-w-xs rounded-lg border border-primary">
            ...
            <div className="md:col-span-5 md:mt-16">
              <div className="bg-surface rounded-lg overflow-hidden shadow-lg border border-primary">
                <img
                  src="https://res.cloudinary.com/djvqjz65z/image/upload/f_auto,q_auto/v1784301773/18_esjwei.webp"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-gutter">
            {reviews.map((review, i) => (
              <motion.div
                ...
                viewport={{ once: true }}
                variants={fadeUp}
                className="bg-surface p-8 rounded-xl border border-primary shadow-sm flex flex-col justify-between"
              >
                <div>
